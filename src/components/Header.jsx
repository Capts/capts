    ...
    <header className="p-4 bg-gray-800 text-gray-100">
        <div className="container flex justify-between h-16 mx-auto my-4 md:justify-center md:space-x-8">
           {/* <ul className="items-stretch hidden space-x-3 md:flex">
            ...
            <a href="/" rel="noopener" aria-label="Back to homepage" className="flex items-center p-2">
                <img src="/src/assets/img/avatar-2-1.png" className="p-2 border-teal-400 border-2 animate-[pulse_8s_ease-in-out_infinite] rounded-full max-w-sm shadow-2x w-20 h-20 text-violet-400" />
